...
function ProfileRoutes(props) {
    ...
    return (
        <div>
            ...
            <PrivateRoute
                exact path={"/profile/compare-budgets"}
            ...
            <PrivateRoute
                exact path={"/profile/compare-locations"}
            ...
            <PrivateRoute
                exact path={"/profile/entertainment"}
                budget={props.budget}
            ...
            <PrivateRoute
                exact path={"/profile/food-drinks"}
                budget={props.budget}
                component={Food}
                user={props.currentUser}
                inputs={food.inputs}
            ...
            <PrivateRoute
                exact path={"/profile/transportation"}
                budget={props.budget}
