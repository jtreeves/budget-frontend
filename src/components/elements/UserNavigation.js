...
function UserNavigation(props) {
  return (
    <div>
      {/* TURNED OFF LOGO COMPONENT */}
      {/* <Logo /> */}
      <h4>Budget</h4>
      {/* May convert to NavLink later */}
      <Link className="" to="/income">
        Income
      </Link>
      <Link className="" to="/housing">
        Housing
      </Link>
      <Link className="" to="/utilities">
        Utilities
      </Link>
      <Link className="" to="/transportation">
        Transportation
      </Link>
      <Link className="" to="/fooddrink">
        Food & Drink
      </Link>
      <Link className="" to="/Miscellaneous">
        Miscellaneous
      </Link>
      <hr />
      <h4>Saved Budgets</h4>
