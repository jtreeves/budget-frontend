...
function DefaultProfile(props) {
    ...
    return (
        <div>
            ...
            />
            <CompactDisplay 
                compactContainerId="cc-housing" 
                title="Housing" 
                inputs={housing.inputs} 
                total={subTotals.housing}
            />
            <CompactDisplay 
                compactContainerId="cc-utility"
                title="Utilities" 
                inputs={utility.inputs} 
                total={subTotals.utility}
            />
            <CompactDisplay 
                compactContainerId="cc-food" 
                title="Food & Drink" 
                inputs={food.inputs} 
                total={subTotals.food}
            />
            <CompactDisplay         
                compactContainerId="cc-transportation" 
                title="Transportation" 
                inputs={transportation.inputs} 
                total={subTotals.transportation}
            />
            <CompactDisplay 
                compactContainerId="cc-entertainment" 
                title="Entertainment" 
                inputs={entertainment.inputs} 
                total={subTotals.entertainment}
            />
            <CompactDisplay 
                compactContainerId="cc-misc" 
                title="Miscellaneous" 
                inputs={misc.inputs} 
                total={subTotals.misc}
            />
        </div>
    )
}
